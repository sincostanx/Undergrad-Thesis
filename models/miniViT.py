...
from .layers import PatchTransformerEncoder, PixelWiseDotProduct, SeperableConv2d
...
class mViT(nn.Module):
    def __init__(self, in_channels, n_query_channels=128, patch_size=16, dim_out=256,
        ...
        self.conv3x3 = SeperableConv2d(in_channels=in_channels, out_channels=embedding_dim, kernel_size=3, activation=["relu", "none"])
